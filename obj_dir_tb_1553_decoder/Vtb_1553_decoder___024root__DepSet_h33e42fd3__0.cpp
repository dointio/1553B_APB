...
void Vtb_1553_decoder___024root___eval_triggers__act(Vtb_1553_decoder___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_1553_decoder___024root___eval_triggers__act\n"); );
    // Body
    vlSelf->__VactTriggered.at(0U) = ((IData)(vlSelf->tb_1553_decoder__DOT__tb_data_clk) 
                                      & (~ (IData)(vlSelf->__Vtrigrprev__TOP__tb_1553_decoder__DOT__tb_data_clk)));
